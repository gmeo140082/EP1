  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse navbar-responsive-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="postre.php">Postres</a></li>
...
<div class="front absolute col-xs-12">
    ...
    <?php  
		...
		$result = mysqli_query($conec, "SELECT * FROM producto where categoria_id=2"); //query de mysql para obtener los tacos 
